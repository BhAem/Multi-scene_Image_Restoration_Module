...
parser.add_argument('--model', type=str, default='models.MSBDNs.Net')
parser.add_argument('--dataset', type=str, default='utils.dataset.DatasetForInference')
parser.add_argument('--checkpoint', type=str, default='./t-sne-weights/sanyang')
...
def main():
    ...
    with torch.no_grad():
        ...
        for img_path in img_dir:
            ...
            pred, feature = model(input_image)
        ...
        np.save('./t-sne-weights/sanyang-night.npy', encoding_array)

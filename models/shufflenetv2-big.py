...
class Net(nn.Module):
    def __init__(self, res_blocks=4):
        ...
        self.conv2x = InvertedResidual(16, 32, stride=2, expand=4)
        ...
        self.conv4x = InvertedResidual(32, 64, stride=2, expand=4)
        ...
        self.conv8x = InvertedResidual(64, 128, stride=2, expand=4)
        ...
        self.conv16x = InvertedResidual(128, 256, stride=2, expand=4)
